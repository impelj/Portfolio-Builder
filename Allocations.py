...
PORTFOLIO_ALLOCATIONS = {
    'Conservative': {
        ...
        'allocations': {
            ...
            'Real Estate': {
                'pct': 0.01,
                'categories': ['Real Estate', 'Infrastructure', 'Global Real Estate'] 
            },
    ...
    'Moderately Conservative': {
        'description': '45% Equity, 55% Fixed Income',
        'allocations': {
            'US Equity Large Cap': {
                'pct': 0.20,
            ...
            'Real Estate': {
                'pct': 0.01,
                'categories': ['Real Estate', 'Infrastructure']
            },
            'Short-term Fixed Income': {
                'pct': 0.48,
                'categories': ['Corporate Bond - High Quality', 'Government Bond - General', 'Government Bond - Treasury', 'Worldwide Bond','Short-Term Inflation-Protected Bond', 'Short-Term Bond','Ultrashort Bond','Short Government']
    ...
    'Moderate': {
        'description': '50% Equity, 50% Fixed Income',
        'allocations': {
            'US Equity Large Cap': {
                'pct': 0.25,
    ...
    'Moderately Aggressive': {
        'description': '70% Equity, 30% Fixed Income',
        'allocations': {
            'US Equity Large Cap': {
                'pct': 0.35,
     ...
     'Aggressive': {
        'description': '90% Equity, 10% Fixed Income',
        'allocations': {
            'US Equity Large Cap': {
                'pct': 0.45,
 ...
 'Ultra Aggressive': {
        'description': '100% Equity, 0% Fixed Income',
        'allocations': {
            'US Equity Large Cap': {
                'pct': 0.46,
                'categories': ['Large Value', 'Large Blend', 'Equity-Income', 'Growth and Income', 'Large Value', 'Aggressive Allocation']
